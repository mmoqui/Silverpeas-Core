...
public interface FileItem {
   ...
   * @throws UncheckedIOException if an I/O error occurs. If the charset if
   */
   ...
   * indicator of a security attack. If you intend to use the file name anyways, catch the exception
