...
public abstract class DataSetTest {
  ...
  @Rule
  public DbSetupRule dbSetupRule = getDbSetupRule();
  ...
  /**
   * Gets the necessary to initialize the data into the database.<br> If null, then the database
   * isn't set up with some data.
   *
  ...
  private DbSetupRule getDbSetupRule() {
